...
//*****************************************************************************
  ...
  {
    uint8 ucMsgVersion;            //!< The version of the message protocol
    uint8 ucMsgSize;               //!< Size of the message
    uint8 ucMsgType;               //!< Type of Label Message
    uint8 ucSensorNumber;          //!< Sensor Number
